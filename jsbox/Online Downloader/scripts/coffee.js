...
var showview
function coffee(show) {
  showview = show
  $http.get({
    url: "https://raw.githubusercontent.com/Neurogram-R/JSBox/master/Coffee.json",
    handler: function (resp) {
      ...
      showCoffeeView(listData)
    }
  })
}

function showCoffeeView(data) {
  var scrollStop = data.length * 20
  var coffeeViews = {
    type: "blur",
    props: {
      id: "coffeeBlur",
