  ...
  views: [{
    ...
    events: {
      tapped: function(sender) {
        $app.openURL("alipays://platformapi/startapp?saId=10000007&clientVersion=3.7.0.0718&qrcode=https://qr.alipay.com/c1x050541p57bjkgo3hzbe6")
      }
    },
    layout: function(make, view) {
    ...
    events: {
      tapped: function(sender) {
        $app.openURL("alipays://platformapi/startapp?saId=10000007&clientVersion=3.7.0.0718&qrcode=https://qr.alipay.com/a2x004157bdeb7sxy4gh384")
      }
    },
    layout: function(make, view) {
      make.top.inset(66)
    ...
    events: {
      tapped: function(sender) {
        $app.openURL("alipays://platformapi/startapp?saId=10000007&clientVersion=3.7.0.0718&qrcode=https://qr.alipay.com/c1x04480hni5tz00ogr88f3")
      }
    },
    layout: function(make, view) {
      make.bottom.inset(66)
